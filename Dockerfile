FROM centos:6.7 
MAINTAINER Pratik Mehta <pratimeh@in.ibm.com> 

RUN yum update -y && yum install -y openssh-server openssh-clients epel-release && yum update -y
...
#RUN yum update -y
#RUN yum install -y ./epel-release-latest-*.noarch.rpm
